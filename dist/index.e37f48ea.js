...
const controlRecipes = async function() {
    try {
        ...
        //0.Updating the results view to mark selected search result
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        //Render the recipe in the recipe view
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
        //Succes message
...
const updateServings = function(newServings) {
    ...
    //newQuanatity=oldQuantity*newServings/oldServings
    });
...
const KEY = "0201c698-f754-4819-9148-a8491189bbc8";
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../helpers.js":"hGI1E"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = `No bookmarks yet.Find a recipe that you like and bookmark it`;
    _message = ``;
    addHandlerRender(handler) {
